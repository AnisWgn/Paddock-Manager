...
--
-- Host: localhost:3306
-- Generation Time: Mar 18, 2026 at 10:48 PM
...
INSERT INTO `game` (`id`, `title`, `year`, `platform`, `description`) VALUES
...
INSERT INTO `plateforme` (`id`, `name`, `manufacturer`, `color`) VALUES
(1, 'PS5', 'Sony', '#0037AE'),
(2, 'PS4', 'Sony', '#0037AE'),
(3, 'PS3', 'Sony', '#0037AE'),
(4, 'PS2', 'Sony', '#0037AE'),
